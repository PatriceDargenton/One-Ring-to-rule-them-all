...
' Install-Package TensorFlow.NET -Version 0.14.1
...
#If Implementation Or TENSORFLOW Then
...
#If Implementation Or TENSORFLOW Then
    ...
    Private Sub InitializeTensorFlow()
        ...
        Dim dllPathDotNetCore = exePath & "\runtimes\win-x64\native\tensorflow.dll"
        If Not System.IO.File.Exists(dllPath) AndAlso
           Not System.IO.File.Exists(dllPathDotNetCore) Then
            Const TFDllPath = "\packages\Microsoft.ML.TensorFlow.Redist." & versionRedist &
                "\runtimes\win-x64\native\tensorflow.dll"
            ...
            Dim srcDllPath4 = System.IO.Path.GetDirectoryName(
                System.IO.Path.GetDirectoryName(
                System.IO.Path.GetDirectoryName(exePath))) & "\SolutionDotNet4" & TFDllPath
            If Not System.IO.File.Exists(srcDllPath) AndAlso
               Not System.IO.File.Exists(srcDllPath2) AndAlso
               Not System.IO.File.Exists(srcDllPath3) AndAlso
               Not System.IO.File.Exists(srcDllPath4) Then _
            ...
            ElseIf System.IO.File.Exists(srcDllPath4) Then
                System.IO.File.Copy(srcDllPath4, dllPath)
            End If
        End If
