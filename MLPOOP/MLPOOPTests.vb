...
Namespace OOPMLP
    ...
    Public Class MultiLayerPerceptronOOPTest
        ...
        Public Sub MLPOOP3XORSigmoid()
            ...
            Dim arVal1#(,) = {
                {0.13, 0.95, 0.86, 0.35, 0.67, 0.14, 0.05},
                {0.95, 0.37, 0.84, 0.71, 0.51, 0.26, 0.17},
                {0.93, 0.7, 0.44, 0.19, 0.57, 0.57, 0.68},
                {0.68, 0.31, 0.58, 0.61, 0.35, 0.51, 0.18},
                {0.11, 0.35, 0.19, 0.18, 0.65, 0.91, 0.71},
                {0.21, 0.45, 0.33, 0.42, 0.87, 0.49, 0.08}}
            Dim arVal2#(,) = {
                {0.21, 0.62, 0.41, 0.19, 0.28, 0.51, 0.6},
                {0.65, 0.09, 0.27, 0.74, 0.52, 0.6, 0.73},
                {0.16, 0.56, 0.55, 0.28, 0.77, 0.64, 0.83}}
