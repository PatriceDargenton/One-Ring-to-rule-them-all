...
Namespace OOPMLP
    ...
    Public Class MultiLayerPerceptronOOPTest
        ...
        'Private m_mlp As New clsMLPClassic ' 4/11 fails

        ' Weights are not stored in the same way:
        'Private m_mlp As New MatrixMLP.MultiLayerPerceptron ' 11/11 fails
        'Private m_mlp As New VectorizedMatrixMLP.clsVectorizedMatrixMLP ' 11/11 fails
        ...
        Public Sub MLPOOP1XORELU()
            ...
            m_mlp.Init(learningRate:=0.05!, weightAdjustment:=0.0!)
            InitXOR()
