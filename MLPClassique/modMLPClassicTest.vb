...
Module modMLPClassicTest
    ...
    Public Sub ClassicMLPTest()
        ...
        'mlp.SetActivationFunction(TActivationFunction.ReLu, gain:=1, center:=0)
        'nbIterations = 10000 ' ReLU: work
...
Public Class MultiLayerPerceptronTest
    ...
    Public Sub MLPXORHReLU()
        ...
        m_mlp.SetActivationFunction(TActivationFunction.ReLu, gain:=1, center:=0)
    ...
    '    Dim arVal2#(,) = {
    '        {0.29, 0.34, 0.81}}
    '    m_mlp.InitPoids(1, arVal1)
    '    m_mlp.InitPoids(2, arVal2)
